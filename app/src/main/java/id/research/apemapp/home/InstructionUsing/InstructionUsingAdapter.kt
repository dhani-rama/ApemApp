    ...
    class viewPagerHolderView(private val binding: ItemInstructionBinding) :
        ...
        fun bind(listItem: InstructionItemEntity) {
            with(binding) {
                ...
                tvFirstNumber.text = listItem.firstNumber
                tvSecondNumber.text = listItem.secondNumber
                tvThirdNumber.text = listItem.thirdNumber
                tvFourthNumber.text = listItem.fourthNumber

                tvFirstExplaination.text = listItem.firstExplanation
                tvSecondExplaination.text = listItem.secondExplanation
                tvThirdExplaination.text = listItem.thirdExplanation
                tvFourthExplaination.text = listItem.fourthExplanation
